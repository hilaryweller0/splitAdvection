...
\documentclass[12pt,a4paper,english,british]{qjrms4}
\usepackage{mathptmx}
...
\title{Dimension Splitting and a Long Time-Step Multi-Dimensional Scheme
for Atmospheric Transport}


\author{Yumeng Chen, Hilary Weller, Stephen Pring and James Shaw}
...
Accurate long time steps can be achieved without significant cost
using the flux-form semi-Lagrangian technique. The dimensionally split
scheme used in this paper is constructed from the one-dimensional
Piecewise Parabolic Method and extended to two dimensions using COSMIC
splitting. The dimensionally split scheme is compared with a genuinely
multi-dimensional, method of lines scheme with implicit time-stepping
which is stable for very large Courant numbers.

Two-dimensional advection test cases on Cartesian planes are proposed
that avoid the complexities of a spherical domain or multi-panel meshes.
These are solid body rotation, horizontal advection over orography
and deformational flow. The test cases use distorted meshes either
to represent sloping terrain or to mimic the distortions of a cubed
sphere.

Such mesh distortions are expected to accentuate the errors associated
with dimension splitting, however, the dimensionally split scheme
is very accurate on orthogonal meshes and accuracy decreases only
a little in the presence of large mesh distortions. The dimensionally
split scheme retains accuracy when long time-steps are used. The multi-dimensional
scheme is almost entirely insensitive to mesh distortions and asymptotes
to second-order accuracy at high resolution. As is expected for implicit
...
A naive estimate of computational cost (number of multiplies) reveals
that the implicit scheme is  the most expensive, particularly for
large Courant numbers. If the multi-dimensional scheme is used instead
with explicit time-stepping, the Courant number is restricted to less
than one but the cost becomes similar to the dimensionally split scheme.
\end{abstract}
\begin{keywords}
hello
\end{keywords}
...
\scalebox{0.5}[0.5]{\input{figs/cubicUpCPCstencil.pstex_t}}\hfill{}\scalebox{0.5}[0.5]{\input{figs/hexStencil.pstex_t}}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics[width=0.49\textwidth,height=0.49\textwidth]{HilarysGraphics/solidBodyRotationOnPlane_nonOrthog_50x50_analytic_constant_mesh}
\par\end{centering}
...
\includegraphics[width=0.49\textwidth]{HilarysGraphics/solidBodyRotationOnPlane_orthogonal_100x100_dt_1_Tcontours} & \includegraphics[width=0.49\textwidth]{HilarysGraphics/solidBodyRotationOnPlane_nonOrthog_100x100_dt_1_Tcontours}\tabularnewline
\multicolumn{2}{c}{\includegraphics[width=0.9\linewidth]{HilarysGraphics/solidBodyRotationOnPlane_legends_Tdiff}}\tabularnewline
\end{tabular}
...
\begin{tabular}{cc}
Orthogonal, dimensionally split scheme & Non-orthogonal, dimensionally split scheme\tabularnewline
\includegraphics[width=0.49\textwidth]{YumengsGraphics/solidBodyRotationOnPlane_orthogonal_100x100_dt_10_TcontoursBig} & \includegraphics[width=0.49\textwidth]{YumengsGraphics/solidBodyRotationOnPlane_nonOrthog_100x100_dt_10_TcontoursBig}\tabularnewline
Orthogonal, multi-dimensional scheme & Non-orthogonal, multi-dimensional scheme\tabularnewline
\includegraphics[width=0.49\textwidth]{HilarysGraphics/solidBodyRotationOnPlane_orthogonal_100x100_dt_10_TcontoursBig} & \includegraphics[width=0.49\textwidth]{HilarysGraphics/solidBodyRotationOnPlane_nonOrthog_100x100_dt_10_TcontoursBig}\tabularnewline
\multicolumn{2}{c}{\includegraphics[width=0.9\linewidth]{HilarysGraphics/solidBodyRotationOnPlane_legends_TdiffBig_Tdiff}}\tabularnewline
\end{tabular}
...
\includegraphics[width=0.49\textwidth]{HilarysGraphics/solidBodyRotationOnPlane_plots_l2errorsC1} & \includegraphics[width=0.49\textwidth]{HilarysGraphics/solidBodyRotationOnPlane_plots_linferrorsC1}\tabularnewline
...
\includegraphics[width=0.49\textwidth]{HilarysGraphics/solidBodyRotationOnPlane_plots_l2errorsC10} & \includegraphics[width=0.49\textwidth]{HilarysGraphics/solidBodyRotationOnPlane_plots_linferrorsC10}\tabularnewline
\end{tabular}
\par\end{centering}
...
\includegraphics[width=0.49\textwidth]{HilarysGraphics/solidBodyRotationOnPlane_plots_l2errors_dt} & \includegraphics[width=0.49\textwidth]{HilarysGraphics/solidBodyRotationOnPlane_plots_linferrors_dt}\tabularnewline
\end{tabular}
\par\end{centering}
...
\begin{figure}
\includegraphics[width=1\textwidth]{HilarysGraphics/deformingAdvectionCyclic_nonOrthogW_c1_120x60_0_TUmesh}

\includegraphics[width=1\textwidth]{HilarysGraphics/deformingAdvectionCyclic_legends_Tmesh_T}
...
1 & \includegraphics[width=0.49\textwidth,valign=m]{YumengsGraphics/deformationalData/plots/T1} & \includegraphics[width=0.49\textwidth,valign=m]{HilarysGraphics/deformingAdvectionCyclic_nonOrthogW_c1_480x240_1_T}\tabularnewline
2 & \includegraphics[width=0.49\textwidth,valign=m]{YumengsGraphics/deformationalData/plots/T2} & \includegraphics[width=0.49\textwidth,valign=m]{HilarysGraphics/deformingAdvectionCyclic_nonOrthogW_c1_480x240_2_T}\tabularnewline
3 & \includegraphics[width=0.49\textwidth,valign=m]{YumengsGraphics/deformationalData/plots/T3} & \includegraphics[width=0.49\textwidth,valign=m]{HilarysGraphics/deformingAdvectionCyclic_nonOrthogW_c1_480x240_3_T}\tabularnewline
4 & \includegraphics[width=0.49\textwidth,valign=m]{YumengsGraphics/deformationalData/plots/T4} & \includegraphics[width=0.49\textwidth,valign=m]{HilarysGraphics/deformingAdvectionCyclic_nonOrthogW_c1_480x240_4_T}\tabularnewline
5 & \includegraphics[width=0.49\textwidth,valign=m]{YumengsGraphics/deformationalData/plots/T5} & \includegraphics[width=0.49\textwidth,valign=m]{HilarysGraphics/deformingAdvectionCyclic_nonOrthogW_c1_480x240_5_T}\tabularnewline
\multicolumn{3}{c}{\includegraphics[width=0.98\textwidth]{HilarysGraphics/deformingAdvectionCyclic_legends_T}}\tabularnewline
\end{tabular*}
...
\includegraphics[width=0.48\linewidth]{HilarysGraphics/deformingAdvectionCyclic_plots_l2errors_c1} & \includegraphics[width=0.48\linewidth]{HilarysGraphics/deformingAdvectionCyclic_plots_linferrors_c1}\tabularnewline
$\ell_{2}$ error, $c\le10$ & $\ell_{\infty}$ error, $c\le10$\tabularnewline
\includegraphics[width=0.48\linewidth]{HilarysGraphics/deformingAdvectionCyclic_plots_l2errors_c10} & \includegraphics[width=0.48\linewidth]{HilarysGraphics/deformingAdvectionCyclic_plots_linferrors_c10}\tabularnewline
\end{tabular}
...
\begin{tabular}{cc}
$\ell_{2}$ error & $\ell_{\infty}$ error\tabularnewline
\includegraphics[width=0.48\linewidth]{HilarysGraphics/deformingAdvectionCyclic_plots_l2errors_dt} & \includegraphics[width=0.48\linewidth]{HilarysGraphics/deformingAdvectionCyclic_plots_linferrors_dt}\tabularnewline
\end{tabular}
